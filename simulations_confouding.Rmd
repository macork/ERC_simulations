...
* Add causalGPS to type of fit here, and see how it does in terms of bias compared to others (should see difference since it is correctly accouting in all cases)
